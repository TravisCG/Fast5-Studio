#############################################################################
# Makefile for building: Fast5-Studio
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Fast5-Studio.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile Fast5-Studio.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lhdf5 -L/usr/lib/x86_64-linux-gnu -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = fast5studio.cpp \
		mainwindow.cpp \
		fast5files.cpp moc_mainwindow.cpp
OBJECTS       = fast5studio.o \
		mainwindow.o \
		fast5files.o \
		moc_mainwindow.o
...
Makefile: Fast5-Studio.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Fast5-Studio.pro
...
dist: 
	@test -d .tmp/Fast5-Studio1.0.0 || mkdir -p .tmp/Fast5-Studio1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Fast5-Studio1.0.0/ && $(COPY_FILE) --parents mainwindow.h fast5files.h .tmp/Fast5-Studio1.0.0/ && $(COPY_FILE) --parents fast5studio.cpp mainwindow.cpp fast5files.cpp .tmp/Fast5-Studio1.0.0/ && (cd `dirname .tmp/Fast5-Studio1.0.0` && $(TAR) Fast5-Studio1.0.0.tar Fast5-Studio1.0.0 && $(COMPRESS) Fast5-Studio1.0.0.tar) && $(MOVE) `dirname .tmp/Fast5-Studio1.0.0`/Fast5-Studio1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Fast5-Studio1.0.0
...
fast5studio.o: fast5studio.cpp /usr/include/qt5/QtWidgets/QApplication \
		...
		/usr/include/qt5/QtCore/QVector \
		/usr/include/qt5/QtCore/QString
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fast5studio.o fast5studio.cpp
...
fast5files.o: fast5files.cpp fast5files.h \
		/usr/include/qt5/QtCore/QVector \
		/usr/include/qt5/QtCore/qvector.h \
		/usr/include/qt5/QtCore/qalgorithms.h \
		/usr/include/qt5/QtCore/qglobal.h \
		...
		/usr/include/qt5/QtCore/qset.h \
		/usr/include/qt5/QtCore/qcontiguouscache.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fast5files.o fast5files.cpp
