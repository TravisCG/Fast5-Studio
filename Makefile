...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Fast5-Studio1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/Fast5-Studio1.0.0/ && $(COPY_FILE) --parents fast5studio.cpp mainwindow.cpp .tmp/Fast5-Studio1.0.0/ && (cd `dirname .tmp/Fast5-Studio1.0.0` && $(TAR) Fast5-Studio1.0.0.tar Fast5-Studio1.0.0 && $(COMPRESS) Fast5-Studio1.0.0.tar) && $(MOVE) `dirname .tmp/Fast5-Studio1.0.0`/Fast5-Studio1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Fast5-Studio1.0.0
